...
synthetic_data$age <- pmax(17, pmin(90, synthetic_data$age))
synthetic_data$hours_per_week <- pmax(1, pmin(99, synthetic_data$hours_per_week))

# Round integer columns
synthetic_data$age <- round(synthetic_data$age)
synthetic_data$education_num <- round(synthetic_data$education_num)
synthetic_data$hours_per_week <- round(synthetic_data$hours_per_week)
